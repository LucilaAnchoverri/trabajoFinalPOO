...
var fs = require("fs");
var FabricaDeJuegos_1 = require("./FabricaDeJuegos");
//instanciamos la fábrica de juegos:
var fabrica = new FabricaDeJuegos_1.FabricaDeJuegos();
...
var saldoFinal = 0; //se almacena el saldo final.
var juegosJugados = ""; //variable para acumular los juegos jugados
var Pdados = null;
var Pruleta = null;
var tragamonedasTG = null;
...
var tragamonedasCB = null;
var continuar = true; //lógica del juego:
while (continuar) {
    ...
    switch (opcion) {
        case 1:
            ...
            if (!Pdados) { //si Pdados es 'null', es porque el juego no ha sido creado todavía.
                ...
                var saldoDados = readlineSync.questionInt("- Ingrese saldo: $");
                ...
                Pdados = fabrica.crearJuego("Dados", { numeroDeDados: 2, saldo: saldoDados });
                ...
                console.log("- Sigues jugando en Dados. Tu saldo disponible para apostar es de: $".concat(saldoAcumulado));
        ...
        case 2:
            ...
            if (!Pruleta) { //si Pruleta es 'null', es porque el juego no ha sido creado todavía.
                //Entonces, si no hay instancia previa, se pide el saldo y se crea el juego:
                var saldoRuleta = readlineSync.questionInt("- Ingrese saldo: $");
                ...
                var tipoApuesta = readlineSync.question("- Queres apostar por color (rojo/negro) o por numero (0-36)? (Ingrese 'color' o 'numero'): ").toLowerCase();
                var apuesta = void 0;
                if (tipoApuesta === "numero") {
                    //si apuesta por "numero", se le pide uno entre 0 y 36:
                    var numeroApuesta = readlineSync.questionInt("- Ingrese el numero a apostar (0-36): ");
                    ...
                    var colorApuesta = readlineSync.question("- Ingrese el color a apostar (rojo o negro): ");
                ...
                Pruleta = fabrica.crearJuego("Ruleta", { tipoDeApuesta: tipoApuesta, apuesta: apuesta, saldo: saldoRuleta });
                ;
                ...
                //en caso de que ya exista una instancia de tragamonedas, se reutilizará
                //tampoco solicita saldo de nuevo.
                console.log("- Sigues jugando en Ruleta. Tu saldo disponible para apostar es de: $".concat(saldoAcumulado));
        ...
        case 3:
            ...
            if (!tragamonedasTG) { //si tragamonedasTG es 'null', es porque el juego no ha sido creado todavía.
                //Entonces, si no hay instancia previa, se pide el saldo y se crea el juego:
                var saldoTragamonedasTG = readlineSync.questionInt("- Ingrese saldo: $");
                if (isNaN(saldoTragamonedasTG) || saldoTragamonedasTG <= 0) {
                    //si no es numero o es menor a 0, entonces consologuea:
                    console.log("- Por favor, ingresa un saldo valido.");
                    break;
                }
                tragamonedasTG = fabrica.crearJuego("TragamonedasTiroGratis", { saldo: saldoTragamonedasTG }); //Pasa un objeto
                ...
                //en caso de que ya exista una instancia de tragamonedas, se reutilizará
                //tampoco solicita saldo de nuevo.
                console.log("- Sigues jugando en Tragamonedas Tiro Gratis. Tu saldo disponible para apostar es de: $".concat(saldoAcumulado));
                juegosJugados += "- Tragamonedas Tiro Gratis "; //acumula el nombre del juego.
            }
            break;
        case 4:
            ...
            if (!tragamonedasCB) { //si tragamonedasBC es 'null', es porque el juego no ha sido creado todavía.
                //Entonces, si no hay instancia previa, se pide el saldo y se crea el juego:
                var saldoTragamonedasCB = readlineSync.questionInt("- Ingrese saldo: $");
                if (isNaN(saldoTragamonedasCB) || saldoTragamonedasCB <= 0) {
                    //si no es numero o es menor a 0, entonces consologuea:
                    console.log("- Por favor, ingresa un saldo válido.");
                    break;
                }
                tragamonedasCB = fabrica.crearJuego("TragamonedasBonus", { saldo: saldoTragamonedasCB });
                ...
                console.log("- Sigues jugando en Tragamonedas con Bonus. Tu saldo disponible para apostar es de: $".concat(saldoAcumulado));
    ...
    if (juego) { //Si el juego fue creado correctamente, entonces se ejecuta:
        ...
        var apuesta = readlineSync.questionInt("- Ingrese la cantidad que desea apostar: $");
        ...
        if (!tragamonedasTG.tieneTiradasGratis()) { //Verificar si hay tiradas gratis disponibles
            ...
            var cantidadApostada = readlineSync.questionInt("- Ingrese la cantidad que desea apostar: $ ");
        ...
        console.log("- El saldo en su cuenta es de: $".concat(saldoAcumulado));
        saldoFinal += saldoAcumulado; //acumula el saldo restante
    }
}
//Función para generar un comprobante en formato '.txt':
function generarComprobante(juegos, saldoFinal) {
    var comprobante = "\n\n  - TICKET DE JUEGO -\n  ~ Juegos Jugados: ".concat(juegos, "\n  ~ Saldo Final: $").concat(saldoFinal, "\n  ~ Fecha: ").concat(new Date().toLocaleString(), "\n  \n");
